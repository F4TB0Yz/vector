...
tags:
  - Feature
---
#### **Este módulo gestiona la información detallada de los envíos e integración con J&T**
...
Aunque la visualización principal de "paradas" ocurre en el contexto de una Ruta, el módulo Packages provee las herramientas para crear, importar y corregir la información de los paquetes individuales.
